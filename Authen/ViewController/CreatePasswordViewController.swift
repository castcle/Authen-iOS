...
extension CreatePasswordViewController: ListAdapterDataSource {
    func objects(for listAdapter: ListAdapter) -> [ListDiffable] {
        let items: [ListDiffable] = [CreatePasswordType.password.rawValue] as [ListDiffable]
        return items
    }
