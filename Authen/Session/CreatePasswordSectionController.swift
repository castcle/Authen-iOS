...
extension CreatePasswordSectionController {
    ...
    override func cellForItem(at index: Int) -> UICollectionViewCell {
        let cell = collectionContext?.dequeueReusableCell(withNibName: AuthenNibVars.CollectionViewCell.createPassword, bundle: ConfigBundle.authen, for: self, at: index) ?? CreatePasswordCell()
